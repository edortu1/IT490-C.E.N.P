        ...
        return (
            `<footer class="footer">
                <div class="footer__wrapper wrapper wrapper--constrained">
                    ...
                    <div class="footer__copyright"><a href="https://github.com/edortu1/IT490-C.E.N.P/" target="_blank">View on GitHub</a> <span class="footer__separator"></span> &copy; Kaplunk ${props.currentYear}</div>
                </div>
            </footer>`
        );
    }
